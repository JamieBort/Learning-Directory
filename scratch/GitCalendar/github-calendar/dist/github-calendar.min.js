    ...
    return function () {
        function e(t, r, n) {
            function a(u, s) {
                if (!r[u]) {
                    if (!t[u]) {
                        var i = "function" == typeof require && require; if (!s && i) return i(u, !0);
                        if (o) return o(u, !0);
            ...
            } for (var o = "function" == typeof require && require, u = 0;
                u < n.length;
                u++)a(n[u]);
            return a
        } return e
        ...
        1: [function (e, t) {
            var r = e("github-calendar-parser"), n = e("elly"), a = e("add-subtract-date"), o = e("formatoid"), u = "MMM D, YYYY", s = "MMMM D";
            t.exports = function (e, t, i) {
                e = n(e), i = i || {}, i.summary_text = i.summary_text || 'Summary of pull requests, issues opened, and commits made by <a href="https://github.com/' + t + '" target="blank">@' + t + "</a>", i.global_stats === !1 && (e.style.minHeight = "175px"), i.proxy = i.proxy || function (e) { return "https://urlreq.appspot.com/req?method=GET&url=" + e };
                var c = function l() {
                    return fetch(i.proxy("https://github.com/" + t)).then(function (e) { return e.text() }).then(function (t) {
                        ...
                        if (d.querySelector(".float-left.text-gray").innerHTML = i.summary_text, d.querySelector("include-fragment")) setTimeout(l, 500);
                            ...
                            if (i.responsive === !0) {
                                var f = d.querySelector("svg.js-calendar-graph-svg"), p = f.getAttribute("width"), b = f.getAttribute("height");
                                f.removeAttribute("height"), f.setAttribute("width", "100%"), f.setAttribute("viewBox", "0 0 " + p + " " + b)
                            } if (i.global_stats !== !1) {
                                var m = r(n("svg", d).outerHTML), g = m.current_streak ? o(m.current_streak_range[0], s) + " &ndash; " + o(m.current_streak_range[1], s) : m.last_contributed ? "Last contributed in " + o(m.last_contributed, s) + "." : "Rock - Hard Place", h = m.longest_streak ? o(m.longest_streak_range[0], s) + " &ndash; " + o(m.longest_streak_range[1], s) : m.last_contributed ? "Last contributed in " + o(m.last_contributed, s) + "." : "Rock - Hard Place", y = n("<div>", { "class": "contrib-column contrib-column-first table-column", html: '<span class="text-muted">Contributions in the last year</span>\n                               <span class="contrib-number">' + m.last_year + ' total</span>\n                               <span class="text-muted">' + o(a.subtract(new Date, 1, "year"), u) + " &ndash; " + o(new Date, u) + "</span>" }), M = n("<div>", { "class": "contrib-column table-column", html: '<span class="text-muted">Longest streak</span>\n                               <span class="contrib-number">' + m.longest_streak + ' days</span>\n                               <span class="text-muted">' + h + "</span>" }), x = n("<div>", { "class": "contrib-column table-column", html: '<span class="text-muted">Current streak</span>\n                               <span class="contrib-number">' + m.current_streak + ' days</span>\n                               <span class="text-muted">' + g + "</span>" });
            ...
            t.exports = function (e, t) { return s.run(t, [e, e._useUTC]) }
        }, { days: 3, fillo: 5, months: 10, "parse-it": 11 }], 7: [function (e, t) { t.exports = ["#eee", "#d6e685", "#8cc665", "#44a340", "#1e6823"] }, {}], 8: [function (e, t) {
            var r = e("github-calendar-legend");
            t.exports = function (e) {
                var t = { last_year: 0, longest_streak: -1, longest_streak_range: [], current_streak: 0, current_streak_range: [], weeks: [], days: [], last_contributed: null }, n = [], a = function () { t.current_streak > t.longest_streak && (t.longest_streak = t.current_streak, t.longest_streak_range[0] = t.current_streak_range[0], t.longest_streak_range[1] = t.current_streak_range[1]) };
                return e.split("\n").slice(2).map(function (e) { return e.trim() }).forEach(function (e) {
                    if (e.startsWith("<g transform")) return n.length && t.weeks.push(n) && (n = []);
                    var o = e.match(/fill="(#[a-z0-9]+)"/), u = e.match(/data-date="([0-9\-]+)"/), s = e.match(/data-count="([0-9]+)"/);
                    if (o = o && o[1], u = u && u[1], s = s && +s[1], o) {
                        var i = { fill: o, date: new Date(u), count: s, level: r.indexOf(o) };
            ...
            }(), o = e("regex-escape"), u = function () {
                function e(t) { r(this, e), this.obj = t || {}, this.re = new RegExp("^(" + Object.keys(t).map(o).join("|") + ")") } return a(e, [{
                    key: "run", value: function (e, t) {
                        var r = "";
                        t = t || [];
                        do {
                            var n = e.match(this.re), a = n && n[1], o = a || e.charAt(0);
                            if (a) {
                                var u = this.obj[a];
        ...
        }, { "regex-escape": 12 }], 12: [function (e, t) { function r(e) { return e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&") } r.proto = function () { return RegExp.escape = r, r }, t.exports = r }, {}], 13: [function (e, t) {
            t.exports = function (e, t, r) {
                var n = [], a = e.length;
                if (0 === a) return n;
                var o = 0 > t ? Math.max(0, t + a) : t || 0;
                for (void 0 !== r && (a = 0 > r ? r + a : r);
                    a-- > o;
                )n[a - o] = e[a];
                return n
            }
