...
public class SecondsAndMinutesChallenge_59 {
    ...
    public static String getDurationString(int minutes, int seconds){
        ...
        System.out.println("Minutes as seconds: " + totalSeconds);

        int secondsPerHour = 60*60;
        System.out.println("Seconds per hour: " + secondsPerHour);

        int hours = (totalSeconds - totalSeconds%secondsPerHour)/secondsPerHour;
