...
function arrayCombos() {
  ...
  // I am close. But the code below is producing elements that are all "d's"
...
// jim[0] = [singles[0], singles[0]];
//
// jim[1] = [singles[0], singles[1]];
//
// jim[2] = [singles[0], singles[2]];
//
// jim[3] = ["a", "d"];
//
// jim[4] = ["b", "a"];
