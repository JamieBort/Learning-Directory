...
//        List<VehicleInfo> jsonVehicles = new ArrayList<>();
        ...
        int totalCars = vehicleList.size();
        ...
        for (Vehicle vehicle: vehicleList) {
            sumGallonsOfGas += vehicle.getGasConsumed();
        }
        ...
        for (Vehicle vehicle: vehicleList) {
            sumOilOdometer += vehicle.getOilChange();
        }
        ...
        for (Vehicle vehicle: vehicleList) {
            ...
            lastRow = lastRow.replace("gas", vehicle.getGasConsumed().toString());
            lastRow = lastRow.replace("oil", vehicle.getOilChange().toString());
