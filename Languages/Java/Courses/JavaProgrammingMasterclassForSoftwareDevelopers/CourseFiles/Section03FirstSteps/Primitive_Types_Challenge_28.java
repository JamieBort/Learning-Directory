...
public class Primitive_Types_Challenge_28 {
    ...
    public void primative_types_challenge(byte byteParameter,short shortParameter, int intParameter) {
        long result = (10L * (byteParameter + shortParameter + intParameter));
        System.out.println("result with three parameters: " + result);
    }

    public void primative_types_challenge(byte byteParameter,short shortParameter, int intParameter, long longParameter) {
