...
public class Attempt02 {
    public static void main(String[] args) throws Exception {
        ...
        // my_test("expected", "actual"); // returns false
        // my_test("ails", "fails"); // returns false
        // my_test("this", ""); // returns true
        my_test(":-)", ":-("); // returns false
    }

    // this works except I'm getting an java.lang.StringIndexOutOfBoundsException:
    // error.
